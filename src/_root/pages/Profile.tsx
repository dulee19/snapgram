...
const StabBlock = ({ value, label }: StabBlockProps) => {
  return (
    <div className="flex-center gap-2">
      ...
      <p className="small-semibold lg:base-medium text-light-2">{label}</p>
    </div>
  )
}
      ...
      <div className="profile-inner_container">
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            ...
            <div className="flex gap-8 mt-10 items-center justify-center xl:justfiy-start flex-wrap z-20">
              <StabBlock value={currentUser.posts.length} label="Posts" />
              <StabBlock value={20} label="Followers" />
              <StabBlock value={20} label="Following" />
            </div>
